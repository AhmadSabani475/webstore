            ...
            <div class="p-10">
                ...
                <div
                    ...
                    <div class="mt-2 space-y-3">
                        <input wire:model="data.shipping_line" id="af-payment-billing-address" type="text"
                                        ...
                                        @foreach ($this->regions as $region)
                                            <li class="p-2 cursor-pointer hover:bg-gray-100">
                                                ...
                                                <label for="region-{{ $region->code }}"
                                                    ...
                                                    <input wire:model.live="region_selector.region_selected"
                                                        type="radio" id="region-{{ $region->code }}" class="sr-only"
                                                        value="{{ $region->code }}">
                ...
                @enderror
                <div class="mt-2 space-y-3">
                    <div class="w-full flex text-center justify-center relative">
                    ...
                    <ul class="flex flex-col mt-3">
                        ...
                        <li
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span class="relative">{{ data_get($this->summaries, 'shipping_total_formatted') }}
